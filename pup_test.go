...
func TestMain(t *testing.T) {
	...
	tests := []Test{
		0: {[]string{"#footer"}, ""},
		1: {[]string{"#footer li"}, ""},
		2: {[]string{"#footer li + a"}, "+ is broken"},
		3: {[]string{"#footer li + a attr{title}"}, "+ is broken"},
		4: {[]string{"#footer li > li"}, "> is broken"},
		5: {[]string{"table li"}, ""},
		...
		15: {[]string{".after"}, ".after is broken"},
		16: {[]string{":empty"}, ""},
		17: {[]string{"td:empty"}, ""},
		...
		33: {[]string{"#toc"}, ""},
		34: {[]string{"#toc li + a"}, "+ is broken"},
		35: {[]string{"#toc li + a text{}"}, "+ is broken"},
		36: {[]string{"#toc li + a json{}"}, "+ is broken"},
		37: {[]string{"#toc li + a + span"}, "+ is broken"},
		38: {[]string{"#toc li + span"}, "+ is broken"},
		39: {[]string{"#toc li > li"}, "> is broken"},
